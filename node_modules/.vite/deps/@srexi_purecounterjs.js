        ...
        var e = { 3: function(e2, t2, r2) {
          ...
          var s = function() {
            ...
            return t3 = e3, r3 = [{ key: "setOptions", value: function(e4) {
              ...
              for (var n2 in e4)
                if (0 === Object.keys(t4).length || t4.hasOwnProperty(n2)) {
              ...
              if (0 !== e4.length)
                if (this.intersectionSupport) {
                  ...
                  window.addEventListener && (this.animateLegacy(e4), window.addEventListener("scroll", function(t5) {
              ...
              e4.forEach(function(e5) {
                ...
                if (i3.duration <= 0)
                  return n2.innerHTML = r4.formatNumber(i3.end, i3);
              ...
              if (t4.filesizing || t4.currency) {
                ...
                for (var s2 = 4; s2 >= 0; s2--)
                  if (0 === s2 && (a2 = "".concat(e4.toFixed(i3), " ").concat(o2[s2])), e4 >= this.getFilesizeThreshold(r4, s2)) {
              ...
              for (var t4 = e4.offsetTop, r4 = e4.offsetLeft, n2 = e4.offsetWidth, i3 = e4.offsetHeight; e4.offsetParent; )
                t4 += (e4 = e4.offsetParent).offsetTop, r4 += e4.offsetLeft;
