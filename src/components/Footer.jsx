        ...
        <div className="row gy-4">
          ...
          >
            ...
            <div className="footer-contact pt-3">
              ...
              <meta itemProp="email" content="ultimatehealthdpc@gmail.com" />
              <meta itemProp="telephone" content="+13529016582" />

              <p>
                <strong>Phone:</strong>{' '}
                <a
                  href="tel:+13529016582"
                  className="p-tel text-white"
                  itemProp="telephone"
                >
                  352-901-6582
                </a>
              ...
              <p itemProp="address" itemScope itemType="http://schema.org/PostalAddress">
                <a
                  ...
                  className="p-adr h-adr text-white d-inline-block"
                >
          ...
          <div className="col-lg-2 col-md-3 footer-links">
            ...
            <ul>
              ...
              <li><a href="#">Peptide Therapy</a></li>
          ...
          <div className="col-lg-4 col-md-6 footer-about">
            ...
            <div className="footer-contact">
              <ul className="list-unstyled text-white" itemScope itemType="https://schema.org/Organization">
